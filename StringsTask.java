...
// isEmptyCheck(beginInput);
 int num=getLength(beginInput);
 lengthCheck(numCompress,num);
...
//14 
public String getMultiStrings(String inputString,String checkString)  throws Exception
{
isEmptyCheck(inputString);
isEmptyCheck(checkString);
String str=inputString.concat(checkString);
return str;
}
//15
...
return (myInput.replaceAll(" ",""));
 ...
 isEmptyCheck(joiningSymbol);
  String[] array=joiningSymbol.split(" ");
 return array;
}
//17
